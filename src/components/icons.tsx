...
const PATHS = {
  ...
  dog: (
    <>
      <path d="M8 5.5 4.5 4 3 9.5l3 1.2M16 5.5 19.5 4 21 9.5l-3 1.2" />
      <path d="M6 10.7c0 5 2.6 8.8 6 8.8s6-3.8 6-8.8c0-2.9-2.7-5.2-6-5.2s-6 2.3-6 5.2Z" />
      <path d="M10.5 15.5h3L12 17l-1.5-1.5ZM9.5 11.5v.01M14.5 11.5v.01" />
    </>
  ),
